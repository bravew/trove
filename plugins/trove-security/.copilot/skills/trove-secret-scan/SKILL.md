...
description: "Scan files for accidentally committed secrets, API keys, and credentials. Flags common secret patterns and suggests remediation. Use when: scan for secrets; leaked credentials; check for api keys."
---
