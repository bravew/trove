...
description: "Security review skill that checks code for common vulnerabilities. Covers OWASP Top 10, secret detection, and secure coding patterns. Use when: security review; owasp check; vulnerability audit."
---
