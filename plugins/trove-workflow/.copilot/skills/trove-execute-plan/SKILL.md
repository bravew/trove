...
description: "Execute an approved implementation plan one checkpoint at a time with verification before advancing. Use when: execute the plan; implement this plan; go checkpoint by checkpoint; continue the plan."
---
