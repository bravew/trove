---
name: trove-ship
description: "Front-door ship workflow. Prepare a change for landing by composing the review and commit skills, surfacing a final Decision Gate before any destructive action. Thin orchestrator — defers detail to leaf skills. Use when: ship this change; prepare to land; get this PR-ready; ship workflow."
---
