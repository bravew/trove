...
description: "Laziness Protocol — aim for the most result with the least code and complexity; bias toward deletion and the smallest change that solves the problem. Use when refactoring, weighing diff size, or tempted to add abstractions, layers, or signal threading. Use when: is this over-engineered; simplest change; laziness protocol."
---
