---
name: using-trove
description: "Skill discipline anchor for the Trove marketplace. Loaded once per session; routes the agent to the right trove-* skill before code, planning, review, or git actions. Use when: session start; skill routing; trove bootstrap."
---
