---
name: trove-dispatch
description: "Parallel-agent dispatch workflow. Use when a request contains multiple independent tasks that can be safely delegated. Use when: parallel agents; dispatch tasks; multiple independent tasks; delegate this."
---
