---
name: trove-worktree
description: "Git worktree workflow for spikes, risky experiments, and broad refactors that should not disturb the user's current branch. Use when: spike this; experiment; risky refactor; use a worktree."
---
