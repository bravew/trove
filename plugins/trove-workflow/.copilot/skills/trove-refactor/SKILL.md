---
name: trove-refactor
description: "Behavior-preserving change to structure: rename, extract, inline, dedupe, move, or migrate an internal API. Pin behavior first, migrate callers and delete the legacy API in one wave, prove behavior unchanged on the real artifact. Use for refactors and internal-API migrations. Use when: refactor this; migrate callers; extract this; delete the legacy api."
---
