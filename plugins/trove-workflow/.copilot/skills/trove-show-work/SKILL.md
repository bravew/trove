...
description: "Keep a reviewable decision trail for long-running or unattended work: an append-only TSV log with one row per decision (what, why, evidence, result). Use for autonomous or multi-phase runs, or work a human reviews after stepping away. Use when: keep a decision log; show your work; audit trail for this run."
---
