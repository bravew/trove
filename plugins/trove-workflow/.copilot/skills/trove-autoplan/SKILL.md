---
name: trove-autoplan
description: "Front-door planning workflow. Take an idea and produce implementation-ready output by composing the Trove product skills (spec → user stories → release-note preview). Defers all detail to the leaf skills it calls. Use when: autoplan; turn this idea into a plan; draft an implementation plan; end-to-end planning."
---
