...
description: "Create and repair Obsidian Bases .base files with note filters, formulas, table or card views, grouping, and summaries. Use for Obsidian note views, not SQL databases, spreadsheets, or generic tables. Use when: create an Obsidian Base; fix a Bases formula; build a view of my Obsidian notes."
license: MIT
---
