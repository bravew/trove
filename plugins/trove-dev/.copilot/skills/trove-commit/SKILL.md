---
name: trove-commit
description: "Git commit workflow and message conventions. Use when creating, drafting, or reviewing atomic commits with conventional messages. Use when: commit message; write a commit; draft commit; commit these changes."
---
