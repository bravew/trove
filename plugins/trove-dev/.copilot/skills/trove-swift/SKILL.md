---
name: trove-swift
description: "Swift 6 and SwiftUI coding conventions for iOS development. Auto-activates when working with Swift files. Covers @Observable, async/await, NavigationStack, Swift Testing, and accessibility. Use when: swift conventions; swiftui view; swift testing."
---
