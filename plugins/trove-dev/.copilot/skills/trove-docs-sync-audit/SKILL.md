...
description: "Read-only documentation drift audit comparing what the docs claim against what the code does. Covers READMEs, setup guides, API and env docs, changelogs, examples, and generated docs. Use when asked whether docs are stale, missing, or inconsistent after a code change. This is not a code review. Use when: are the docs stale; do the docs match the code; documentation drift; what docs need updating."
license: MIT
---
