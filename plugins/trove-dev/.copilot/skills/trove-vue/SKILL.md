---
name: trove-vue
description: "Vue 3 Composition API conventions and best practices. Auto-activates when working with Vue single-file components. Covers reactivity, component patterns, Vue Router, and Pinia state management. Use when: vue component; composition api; pinia store."
---
