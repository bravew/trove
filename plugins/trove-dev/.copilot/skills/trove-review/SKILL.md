---
name: trove-review
description: "Code review skill that checks for common issues, security vulnerabilities, and style violations. Use when reviewing code changes or PRs. Use when: code review; review this diff; check this code."
---
