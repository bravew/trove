...
description: "Use the Obsidian CLI to search, read, and make requested changes to an established vault, or inspect an Obsidian plugin during development. Use for explicit Obsidian app operations; requires an available desktop CLI."
license: MIT
when_to_use: "search my Obsidian vault; update a note through Obsidian CLI; debug my Obsidian plugin"
user-invocable: true
metadata:
  source: kepano/obsidian-skills
  upstream-skill: obsidian-cli
