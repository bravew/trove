...
description: "Create, edit, and validate JSON Canvas .canvas files with text, file, link, and group nodes and directed edges. Use for portable visual boards and Obsidian canvases, not HTML canvas code, images, slides, or Mermaid diagrams."
license: MIT
paths:
  - "**/*.canvas"
when_to_use: "create a JSON Canvas board; edit an Obsidian canvas; repair a canvas file"
user-invocable: true
metadata:
  source: kepano/obsidian-skills
  upstream-skill: json-canvas
